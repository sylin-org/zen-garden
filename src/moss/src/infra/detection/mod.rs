...
pub use garden_common::detection::{DetectionResult, detect_by_command, detect_by_http_probe};

// Moss-specific detection (requires Docker)
pub use container_inspect::{ContainerDetector, detect_by_container_inspect};
