...
- Complete spec: [PRESENCE-0001](../decisions/PRESENCE-0001-stone-presence-protocol.md)
- Implementation report: [PRESENCE-0001-COMPLETE](../archive/implementation-reports/presence-protocol-2026-01-26.md)
...
**[CRICKET-IMPLEMENTATION-ROADMAP.md](cricket-implementation-roadmap.md)**
