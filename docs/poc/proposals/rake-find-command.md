...
**Date**: 2026-01-22
**Relates to**: `discovery-topology-caching.md`, `rake-dual-ergonomics.md`
...
- `discovery-topology-caching.md` - Cache architecture
- `rake-dual-ergonomics.md` - Zen/Normative syntax patterns
