...
**Relates to**: `discovery-topology-caching.md`, `discovery-protocol-enhancements.md`
...
- **Topology Caching**: `docs/proposals/discovery-topology-caching.md`
- **Discovery Protocol**: `docs/proposals/discovery-protocol-enhancements.md`
- **CLI Ergonomics**: `docs/proposals/rake-dual-ergonomics.md`
- **Stone Lifecycle**: `docs/proposals/stone-lifecycle-operations.md`
