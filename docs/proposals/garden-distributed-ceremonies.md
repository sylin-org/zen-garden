...
- [Stone Lifecycle Proposal](stone-lifecycle-operations.md) — Related operations (retire, replace, lift)
- [CLI Taxonomy Proposal](ongoing/rake-taxonomy-design.md) — Zen vs normative syntax
