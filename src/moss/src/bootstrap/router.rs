...
pub fn configure(state: AppState) -> Router {
    Router::new()
        ...
        .route("/api/v1/stone/offerings/:name/capabilities/refresh", post(api::v1::offering_capabilities::refresh_offering_capabilities_v1))
        .route("/api/v1/stone/offerings/:name/capabilities/mirror", post(api::v1::offering_capabilities::mirror_offering_capabilities_v1))
