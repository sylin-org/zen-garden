...
//! # Example
//! ```ignore
//! use garden_common::infra::platform::{is_running_from_removable_media, shutdown_signal};
//!
//! let exe_path = std::env::current_exe()?;
//! if is_running_from_removable_media(&exe_path)? {
//!     println!("Running from USB drive");
//! }
//!
//! // In axum server:
...
/// if is_running_from_removable_media(&exe_path)? {
///     println!("Running from USB - will copy to permanent location");
/// }
/// # Ok(())
/// # }
/// ```
