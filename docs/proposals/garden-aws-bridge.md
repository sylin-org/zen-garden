...
**Backend:** Seed Banks (see [Storage API Specification](storage-api-design.md))
...
- [Storage API Specification](storage-api-design.md) — S3 implementation details
- [Cultivation Specification](storage-cultivation-system.md) — Backup/restore mechanics
- [Ceremony Specification](garden-distributed-ceremonies.md) — Distributed operations
