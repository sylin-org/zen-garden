...
>
> The full Pond mode (water metaphor) and Normative mode are reserved for future implementation. See [Companions.md](../guides/companion-overview.md) for current commands and usage.
