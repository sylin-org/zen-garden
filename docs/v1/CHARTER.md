...
| **B2-amended (2026-08-29, operator ruling):** Zen Garden is fully operational WITHOUT Koi, and integrates with it when available. The signing/trust AUTHORITY is a Koi integration (moved to the Integration epic, M6). **Further amended 2026-08-29: M2's TOFU pinning and refuse-unsigned hooks are DEFERRED to M6 as well — the current discipline is trust.** Garden-local security rejoins the roadmap when Koi ships. | L2, L13 |
