...
//!
//! Queries Docker Hub and compatible registries (following Docker Registry HTTP API V2).
//! Supports both Docker Hub and self-hosted registries.
...
impl ImageRef {
    /// Parse Docker image reference (e.g., "redis:7.2.3", "library/redis:7.2", "ghcr.io/owner/repo:v1")
...
/// This resolves what a tag like "latest" or "7.4.0" actually points to
