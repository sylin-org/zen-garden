...
- [Ceremony Specification](zen-garden-spec-ceremonies.md) — Migration ceremonies use similar snapshot methods
- [Offering Modes](zen-garden-spec-offering-modes.md) — How offerings are planted, adopted, borrowed
- [Technical Spec](zen-garden-technical-spec.md) — Moss architecture
- [Pillars](zen-garden-pillars.md) — Failure philosophy
