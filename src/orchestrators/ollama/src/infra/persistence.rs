...
//!
//! Layout:
//!   {data_dir}/router-config.toml
//!   {data_dir}/metrics/summary.json
//!   {data_dir}/metrics/stones/{stone_name}.json

use crate::domain::types::{MetricsSnapshot, RouterConfig, StoneMetrics};
...
pub async fn load_metrics(data_dir: &str) -> MetricsSnapshot {
    ...
    let mut snapshot = MetricsSnapshot {
        ...
        tokens_out_total: summary_val["tokens_out_total"].as_u64().unwrap_or_default(),
