...
5. `docs/v1/decisions/ADR-0001..0009` — directory, ports, FQN namespace, discovery envelope, living will, Suzu contract, surface degrees, catalog sourcing, contract-first codegen
