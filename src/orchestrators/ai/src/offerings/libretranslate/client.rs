//! HTTP client for LibreTranslate API operations.
//!
//! Encapsulates all direct communication with LibreTranslate instances.

use super::types::{HealthResponse, Language};
...
impl LibreTranslateClient {
    ...
    /// List supported languages: `GET /languages`.
    pub async fn languages(&self, endpoint: &str) -> Result<Vec<Language>> {
        ...
        let resp = check_status(resp, "GET /languages").await?;
    ...
    pub async fn forward_request(
        ...
        builder.send().await.context("forward request to LibreTranslate")
    }
}
