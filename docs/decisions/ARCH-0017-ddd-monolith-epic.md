...
| Date | Change | ADR |
|------|--------|-----|
| 2026-04-12 | **Book XIX opened.** AppState Dissolution — plan confirmed: rename `AppState` → `Moss`, inline 7 delegate methods, relocate re-exports, retain `emit_storage_changed` as cross-cutting coordination. 555 occurrences across 97 files (mechanical rename). | [ARCH-0037](ARCH-0037-appstate-dissolution.md) |
